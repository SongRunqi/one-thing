...
export function sanitizeAgentPathSegment(agentId: string, defaultAgentId = 'default'): string {
...
export function canonicalKindFromCaptureKind(kind: MemoryCaptureCandidateKind | string): MemoryCanonicalKind {
...
export function isDurableCandidate(candidate: MemoryDurableCandidateLike): boolean {
