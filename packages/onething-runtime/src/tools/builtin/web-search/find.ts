...
import { fetchSearchPage, type FetchedSearchPage, type FetchFn } from './page-fetch.js'
...
export interface WebFindToolAdapters {
  getFetch?: () => FetchFn
}
...
export function createWebFindTool(
  adapters: WebFindToolAdapters = {},
): Tool.Info<typeof WebFindParameters, WebFindMetadata> {
  return Tool.define<typeof WebFindParameters, WebFindMetadata>('web_find', {
    name: 'Web Find',
