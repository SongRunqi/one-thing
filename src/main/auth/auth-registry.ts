...
export function normalizeGenericOAuthToken(data: any, currentToken?: OAuthToken | null): OAuthToken {
...
function normalizeCodexToken(data: any, currentToken?: OAuthToken | null): OAuthToken {
...
const CLAUDE_CODE_CONFIG: AuthProviderDefinition = {
  ...
  codeEntryInstructions: 'After authorizing, copy the entire code shown on the page, including any # and text after it, and paste it here.',
  normalizeToken: normalizeGenericOAuthToken,
}

const GITHUB_COPILOT_CONFIG: AuthProviderDefinition = {
...
const CODEX_CONFIG: AuthProviderDefinition = {
  providerId: 'codex',
  name: 'Codex',
...
const AUTH_PROVIDERS = new Map<string, AuthProviderDefinition>([
...
export function getAuthProviderDefinition(providerId: string): AuthProviderDefinition | undefined {
  return AUTH_PROVIDERS.get(providerId)
}

export function getAuthProviderDefinitions(): AuthProviderDefinition[] {
