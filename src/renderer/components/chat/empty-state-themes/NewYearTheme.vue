...
function confettiStyle(i: number) {
  ...
  const colors = ['var(--ui-status-warning-fg, #fbbf24)', 'var(--ui-status-danger-fg, #f87171)', 'var(--ui-accent-subtle-fg, #a78bfa)', 'var(--ui-status-success-fg, #34d399)', 'var(--ui-status-info-fg, #60a5fa)']
