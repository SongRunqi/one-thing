...
function normalizeCodexToken(data: any, currentToken?: OnethingOAuthToken | null): OnethingOAuthToken {
...
export function getAuthProviderDefinition(providerId: string): OnethingAuthProviderDefinition | undefined {
