...
type CorePromptToolCall = { toolCallId: string; toolName: string; args: JsonObject }
...
export type CorePromptRequestMessage =
  ...
  | {
      role: 'tool'
      content: Array<{ type: 'tool-result'; toolCallId: string; toolName: string; result: CorePromptMessageContent }>
    }
