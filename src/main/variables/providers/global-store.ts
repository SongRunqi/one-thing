/**
 * GlobalStoreProvider — owns user-defined variables shared by every
 * session. Reserved system names remain owned by their dedicated
 * providers.
 */
...
export class GlobalStoreProvider implements VariableProvider {
  ...
  constructor(
    ...
    private readonly maxGlobal = VARIABLE_LIMITS.MAX_PER_PROVIDER,
  ) {}
