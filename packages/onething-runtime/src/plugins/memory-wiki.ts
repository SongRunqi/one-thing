 ...
 * 一篇正文的字符上限。
 *
 * 8000 字符 ≈ 一份中等长度的架构说明。它同时是一条**分主题的压力** ——
 * 超了不是截断而是结构化拒绝,提示精炼或拆主题:一个装得下一切的主题页,
 * 检索时只会整篇回来,等于把每次 query 都变成一次上下文洪水。
 */
export const ONETHING_MEMORY_MAX_DOCUMENT_CHARS = 8000
