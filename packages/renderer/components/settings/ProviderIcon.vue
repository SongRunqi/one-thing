<template>
  ...
  >
    ...
    <!-- Qwen / 千问 Logo (official mark) -->
    <svg
      v-else-if="normalizedProvider === 'qwen'"
      :width="size"
      :height="size"
      viewBox="0 0 24 24"
      fill="currentColor"
    ...
    <!-- Claude Code Agent (custom brand asset) -->
    <img
      v-else-if="provider === 'claude-code-agent'"
      :src="claudeCodeAgentIcon"
      :width="size"
      :height="size"
      alt=""
      class="provider-icon-image"
    >
    ...
    >
      ...
      <path
        d="M12 2l-1.5 4.5M12 2v5M6 8l4.5-1.5M18 8l-4.5-1.5"
        stroke="currentColor"
        stroke-width="0.8"
        fill="none"
        opacity="0.3"
      />
      <path
        d="M12 22l-2-6-6-2 6-2 2-6 2 6 6 2-6 2-2 6z"
        opacity="0.9"
      />
      <circle
        cx="12"
...
import claudeCodeAgentIcon from '../../assets/provider-icons/claude-code-agent.png'
