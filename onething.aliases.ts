...
export function onethingPackageAliases(projectRoot: string): OnethingAliasEntry[] {
  ...
  { find: '@onething/electron-host/ipc/memory', replacement: resolve(projectRoot, 'apps/electron/src/ipc/memory.ts') },
  { find: '@onething/electron-host/ipc/mcp', replacement: resolve(projectRoot, 'apps/electron/src/ipc/mcp.ts') },
  { find: '@onething/electron-host/ipc/models', replacement: resolve(projectRoot, 'apps/electron/src/ipc/models.ts') },
  ...
  { find: '@onething/electron-host/ipc/prompts', replacement: resolve(projectRoot, 'apps/electron/src/ipc/prompts.ts') },
  { find: '@onething/electron-host/ipc/providers', replacement: resolve(projectRoot, 'apps/electron/src/ipc/providers.ts') },
  ...
  { find: '@onething/electron-host/music/pty-host', replacement: resolve(projectRoot, 'apps/electron/src/music/pty-host.ts') },
  ...
  { find: '@onething/runtime/memory/active-memory', replacement: resolve(projectRoot, 'packages/onething-runtime/src/memory/active-memory.ts') },
  { find: '@onething/runtime/memory/append', replacement: resolve(projectRoot, 'packages/onething-runtime/src/memory/append.ts') },
  { find: '@onething/runtime/memory/capture-actions', replacement: resolve(projectRoot, 'packages/onething-runtime/src/memory/capture-actions.ts') },
  { find: '@onething/runtime/memory/canonical', replacement: resolve(projectRoot, 'packages/onething-runtime/src/memory/canonical.ts') },
  { find: '@onething/runtime/memory/database', replacement: resolve(projectRoot, 'packages/onething-runtime/src/memory/database.ts') },
  { find: '@onething/runtime/memory/daily-context', replacement: resolve(projectRoot, 'packages/onething-runtime/src/memory/daily-context.ts') },
  { find: '@onething/runtime/memory/diagnostics-logger', replacement: resolve(projectRoot, 'packages/onething-runtime/src/memory/diagnostics-logger.ts') },
  { find: '@onething/runtime/memory/dreaming', replacement: resolve(projectRoot, 'packages/onething-runtime/src/memory/dreaming.ts') },
  { find: '@onething/runtime/memory/flush', replacement: resolve(projectRoot, 'packages/onething-runtime/src/memory/flush.ts') },
  { find: '@onething/runtime/memory/graph', replacement: resolve(projectRoot, 'packages/onething-runtime/src/memory/graph.ts') },
  { find: '@onething/runtime/memory/hermes-file-memory', replacement: resolve(projectRoot, 'packages/onething-runtime/src/memory/hermes-file-memory.ts') },
  { find: '@onething/runtime/memory/indexer', replacement: resolve(projectRoot, 'packages/onething-runtime/src/memory/indexer.ts') },
  { find: '@onething/runtime/memory/ipc', replacement: resolve(projectRoot, 'packages/onething-runtime/src/memory/ipc.ts') },
  { find: '@onething/runtime/memory/managed-files', replacement: resolve(projectRoot, 'packages/onething-runtime/src/memory/managed-files.ts') },
  { find: '@onething/runtime/memory/prompt-context', replacement: resolve(projectRoot, 'packages/onething-runtime/src/memory/prompt-context.ts') },
  { find: '@onething/runtime/memory/review', replacement: resolve(projectRoot, 'packages/onething-runtime/src/memory/review.ts') },
  { find: '@onething/runtime/memory/search', replacement: resolve(projectRoot, 'packages/onething-runtime/src/memory/search.ts') },
  { find: '@onething/runtime/memory/types', replacement: resolve(projectRoot, 'packages/onething-runtime/src/memory/types.ts') },
  { find: '@onething/runtime/memory/workspace', replacement: resolve(projectRoot, 'packages/onething-runtime/src/memory/workspace.ts') },
  ...
  { find: '@onething/runtime/tools/builtin/calculator', replacement: resolve(projectRoot, 'packages/onething-runtime/src/tools/builtin/calculator.ts') },
