/**
 * The engine's MCP bridge is hard-bound to the @onething/app singleton manager.
...
import { MCPManager as appMCPManager } from '@onething/app/mcp/index.js'
import {
...
describe('server MCP wiring', () => {
  ...
  it('routes the default owner through the app singleton the engine reads', async () => {
    ...
    // The @onething/app path layer resolves its root from this env var, not
